...
public class DefaultApiService implements ApiService {
  ...
  public void createSecurity(String tickerSymbol, String tradeableItemSymbol, String currencySymbol) {
    ...
    commandGateway.send(new CreateSecurityCommand(SecurityId.next(), new Ticker(tickerSymbol), new org.multibit.exchange.domainmodel.TradeableItem(tradeableItemSymbol), new org.multibit.exchange.domainmodel.Currency(currencySymbol)), callback);
  }
